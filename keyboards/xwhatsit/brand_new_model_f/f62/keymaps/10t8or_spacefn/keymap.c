...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        //      KC_CAPS, KC_LGUI, KC_LALT,                   KC_SPC,                                               KC_RALT, KC_NUM, KC_RCTL
        /* BASE */
	...
	[_FN] = LAYOUT_ansi_hhkb_split_shift_regular_backspace(
		...
		KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          \
                KC_SCRL, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_VOLU, _V_V_V_, \
