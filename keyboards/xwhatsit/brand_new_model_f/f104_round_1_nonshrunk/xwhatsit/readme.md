# xwhatsit/brand_new_model_f/f104_round_1_nonshrunk/xwhatsit
...
* Hardware Supported: Supports the F104 round 1 non-shrunk, by Model F Labs keyboards, using the original Xwhatsit model F rev. 1 or rev. 2 controller PCB.
