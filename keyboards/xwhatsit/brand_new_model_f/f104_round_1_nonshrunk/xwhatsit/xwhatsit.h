...
{ \
    { k_esc,    f_1,        f_3,   f_4,  f_5,    f_6,   f_7,    f_8,         f_9,            f_10,        f_11,       k_prsc,k_scr,             k_paus, k_ast, k_kpminus }, \
    { k_tilde,  f_2,        k_3,   k_4,  k_6,    k_7,   k_9,    k_0,         k_equals,       k_backslash ,f_12,       k_ins, k_home,            k_num,  KC_NO, KC_NO     }, \
    { KC_NO,    k_1,        k_2,   k_5,  k_y,    k_i,   k_8,    k_minus,     KC_NO,          k_squarebrcl,k_backtick, k_end, k_pgup,            k_slash,k_kp9, k_kpplus  }, \
    { k_tab,    k_q,        k_e,   k_r,  k_t,    k_u,   k_o,    k_p,         k_squarebrop,   KC_NO,       k_backspace,k_del, k_pgdn,            k_kp7,  k_kp8, k_kpplus2 }, \
    { k_caps,   k_w,      KC_NO, k_d,  k_g,    k_h,   k_k,    k_l,           k_singlequote,  k_hashtag,   k_ex1,      k_ex2, k_ex3,             KC_NO,  k_kp5, k_kp6     }, \
    { k_lshift, k_a,        k_s,   k_f,  k_c,  k_j,   k_n,  k_semicolon,     k_period,       k_rshift,    k_return,   k_up,  k_ex5,             k_kp4,  k_kp2, k_kpent   }, \
    { KC_NO,    k_nonusbs,  k_z,   k_x,  k_v,    k_b,   k_m,    k_cm,        k_forwardslash, KC_NO,       k_fn,       k_ex4, k_right,           k_kp1,  k_kp3, k_kpdel   }, \
    { k_lctrl,  k_lgui,     k_lalt,KC_NO,k_space,KC_NO, k_extra,KC_NO,       k_ralt,         k_menu,      k_rctrl,    k_left,k_down,            k_kpx,  k_kp0, k_kpent2  }  \
}
