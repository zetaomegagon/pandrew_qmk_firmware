# xwhatsit/brand_new_model_f/fssk_round_1/xwhatsit
...
* Hardware Supported: Supports the FSSK round 1 by Model F Labs keyboards, using the original Xwhatsit model F rev. 1 or rev. 2 controller PCB.
