# xwhatsit/brand_new_model_f/fssk_round_1/universal
...
* Hardware Supported: Supports the FSSK round 1 by Model F Labs keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
