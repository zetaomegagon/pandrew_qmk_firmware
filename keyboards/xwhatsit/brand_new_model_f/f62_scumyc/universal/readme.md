...
* Hardware Supported: Supports the F62 reproduction, with "scumyc" layout, by Model F Labs keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
