...
![xwhatsit/brand_new_model_f/f77/xwhatsit](https://i.imgur.com/f8Z0mwHh.jpeg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the F77 reproduction by Model F Labs keyboards, using the original Xwhatsit model F rev. 1 or rev. 2 controller PCB.
