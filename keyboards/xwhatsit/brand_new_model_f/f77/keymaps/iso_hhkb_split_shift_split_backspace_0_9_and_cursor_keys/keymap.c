...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_iso_hhkb_split_shift_split_backspace(
        ...
        KC_LCTL,      KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NUHS,           KC_P1,   KC_P2,   KC_P3,
    ...
    [_FN] = LAYOUT_iso_hhkb_split_shift_split_backspace(
        ...
        KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP, KC_NO, KC_BSPC,         KC_LEFT,   KC_NO,   KC_RIGHT,
