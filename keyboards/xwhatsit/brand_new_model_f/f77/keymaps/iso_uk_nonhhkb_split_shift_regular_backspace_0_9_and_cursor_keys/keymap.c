...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_iso_nonhhkb_split_shift_regular_backspace(
        ...
        KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(_FN), KC_RSFT,           KC_P0,   KC_UP,   KC_PDOT,
        KC_LCTL,  KC_LGUI, KC_LALT,                      KC_SPC,                  KC_RALT, KC_NUM, KC_RCTL,               KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT_iso_nonhhkb_split_shift_regular_backspace(
        ...
        KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP, KC_NO, KC_NO,           KC_LEFT,   KC_NO,   KC_RIGHT,
