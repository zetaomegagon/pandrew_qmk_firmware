# xwhatsit/brand_new_model_f/beamspring_ssk/xwhatsit

![xwhatsit/brand_new_model_f/beamspring_ssk/xwhatsit](https://www.modelfkeyboards.com/wp-content/uploads/2022/12/2021-08-06_23-42-10-scaled.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the Beamspring SSK by Model F Labs keyboards, using the original Xwhatsit model F rev. 1 or rev. 2 controller PCB.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/brand_new_model_f/beamspring_ssk/xwhatsit:default
