# xwhatsit/ibm/displaywriter/xwhatsit

![xwhatsit/ibm/displaywriter/xwhatsit](https://i.imgur.com/OY39Zjmh.jpeg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Displaywriter Beamspring keyboards, using the original Xwhatsit displaywriter controller PCB.
