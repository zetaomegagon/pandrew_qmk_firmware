...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_F9,  KC_F10,   KC_LCTL,  KC_LGUI, KC_LALT, MO(_FN2), KC_SPC,  KC_SPC,       KC_SPC,             KC_RALT,  KC_RGUI,   KC_RCTL,  KC_P0,   KC_P0,   KC_PDOT, KC_PENT
    ),
    [_FN] = LAYOUT_all(
    ...
    [_FN2] = LAYOUT_all(
        QK_BOOT, KC_NO,      KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
