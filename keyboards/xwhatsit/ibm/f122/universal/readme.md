# xwhatsit/ibm/f122/universal

![xwhatsit/ibm/f122/universal](https://i.imgur.com/Tha5SqIh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Model F F122 keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/ibm/f122/universal:default
