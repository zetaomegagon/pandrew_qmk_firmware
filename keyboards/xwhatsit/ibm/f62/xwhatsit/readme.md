# xwhatsit/ibm/f62/xwhatsit

![xwhatsit/ibm/f62/xwhatsit](https://i.imgur.com/o852pMMh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Model F 4704 F62 "kishsaver" keyboards, using the original Xwhatsit model F rev. 1 or rev. 2 controller PCB.
