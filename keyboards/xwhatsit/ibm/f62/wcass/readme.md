...
![xwhatsit/ibm/f62/wcass](https://i.imgur.com/o852pMMh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Model F 4704 F62 "kishsaver" keyboards, using the wcass controller PCB.
