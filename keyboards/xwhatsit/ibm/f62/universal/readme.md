# xwhatsit/ibm/f62/universal

![xwhatsit/ibm/f62/universal](https://i.imgur.com/o852pMMh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Model F 4704 F62 "kishsaver" keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/ibm/f62/universal:default
