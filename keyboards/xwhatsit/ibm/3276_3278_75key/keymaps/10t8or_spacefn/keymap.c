...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        /* Base Layer */
    [_DEF] = LAYOUT(
        KC_F1, KC_F2,   QK_GESC,       KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,       KC_BSPC,    KC_HOME, LT_END,
    ...
    [_FN] = LAYOUT(
        QK_BOOT, _______, KC_MUTE, KC_VOLU, KC_VOLD,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,           _______,   _V_V_V_,
        KC_NUM , _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______,   _______,
        ...
        KC_SCRL, _______, _______,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                      _______,   _______,
