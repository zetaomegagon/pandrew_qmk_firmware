...
![xwhatsit/ibm/5251/xwhatsit_rev4](https://i.imgur.com/kncrpQBh.jpeg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Beamspring 5251 keyboards, using the original Xwhatsit beamspring controller PCB rev. 4.
