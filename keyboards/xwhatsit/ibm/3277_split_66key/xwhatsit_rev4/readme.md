...
![xwhatsit/ibm/3277_split_66key/xwhatsit_rev4](https://i.imgur.com/CzZI5Inh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the IBM Beamspring 3277 (split 66-key) keyboards, using the original Xwhatsit beamspring controller PCB rev. 4.
