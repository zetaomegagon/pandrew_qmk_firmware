# xwhatsit/ibm/5251_hebrew/universal
...
* Hardware Supported: Supports the IBM Beamspring 5251 (Hebrew variant) keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or the Compact Beamspring controller.
