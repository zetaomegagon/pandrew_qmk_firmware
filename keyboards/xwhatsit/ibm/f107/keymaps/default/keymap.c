...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_102key_ansi(
        KC_ESC,              KC_AUDIO_MUTE,   KC_GRV,   KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,        KC_BSPC, KC_INS,  KC_HOME,  KC_PGUP,      KC_NUM, KC_PSLS, KC_PAST,  KC_PMNS, \
        ...
        KC_MEDIA_PLAY_PAUSE, KC_MEDIA_STOP,   KC_CAPS,        KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,       KC_ENT,  KC_PSCR, KC_SCRL,  KC_PAUS,      KC_P4,   KC_P5,   KC_P6, \
        ...
        TO(_FN2),            TO(_FN3),        KC_LCTL,     MO(_FN1),  KC_LALT,                   KC_SPC,            KC_RALT, MO(_FN2), KC_RGUI,      KC_LEFT, KC_DOWN,  KC_RIGHT,              KC_P0,   KC_KP_DOT \
    ),
