# xwhatsit/ibm/xtant/universal

![xwhatsit/ibm/xtant/universal](https://i.imgur.com/UbgPFWmh.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the Xtant keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/ibm/xtant/universal:default
