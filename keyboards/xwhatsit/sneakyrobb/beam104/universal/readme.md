...
* Hardware Supported: Supports the Sneakyrobb Beam104 keyboards, using one of the xwhatsit controller PCBs supported by the 'universal' driver: the TH_XWhatsIt controller, or one of the SMD Model F controllers.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/sneakyrobb/beam104/universal:default
