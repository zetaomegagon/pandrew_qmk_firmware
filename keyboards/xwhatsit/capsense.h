...
#    define DEFAULT_HARDCODED_SAMPLE_TIME 4
...
#    define CAPSENSE_PHYSICAL_ROW_TO_GPIO_ROW(row) (row)
#    define CAPSENSE_GPIO_ROW_TO_PHYSICAL_ROW(row) (row)
...
#elif defined(CONTROLLER_IS_XWHATSIT_MODEL_F) || defined(CONTROLLER_IS_WCASS_MODEL_F) || defined(CONTROLLER_IS_XWHATSIT_DISPLAYWRITER)
...
#        endif
#        if defined(CONTROLLER_IS_WCASS_MODEL_F)
#            define CAPSENSE_PHYSICAL_ROW_TO_GPIO_ROW(row) (row)
#            define CAPSENSE_GPIO_ROW_TO_PHYSICAL_ROW(row) (row)
...
#            define CAPSENSE_READ_ROWS_VALUE ( \
                    ...
                    (((dest_row_2 >> 3) & 1) << 5))
#        else
#            define CAPSENSE_PHYSICAL_ROW_TO_GPIO_ROW(row) (7-(row))
#            define CAPSENSE_GPIO_ROW_TO_PHYSICAL_ROW(row) (7-(row))
#            define CAPSENSE_READ_ROWS_VALUE ((dest_row_1 >> 4) | (dest_row_2 << 4))
#        endif
#    endif

#elif defined(CONTROLLER_IS_UNIVERSAL_BEAMSPRING) || defined(CONTROLLER_IS_UNIVERSAL_MODEL_F)
...
#        define CAPSENSE_READ_ROWS_EXTRACT_FROM_ARRAY do { dest_row_1 = array[p0++]; dest_row_2 = array[p0++]; } while (0)
#    else
#        define DEFAULT_HARDCODED_SAMPLE_TIME 3
...
#    define CAPSENSE_PHYSICAL_ROW_TO_GPIO_ROW(row) (MATRIX_CAPSENSE_ROWS-1-(row))
#    define CAPSENSE_GPIO_ROW_TO_PHYSICAL_ROW(row) (MATRIX_CAPSENSE_ROWS-1-(row))

#    if (!defined(CAPSENSE_CONDUCTIVE_PLASTIC_IS_PUSHED_DOWN_ON_KEYPRESS)) && (!defined(CAPSENSE_CONDUCTIVE_PLASTIC_IS_PULLED_UP_ON_KEYPRESS))
#        if defined(CONTROLLER_IS_UNIVERSAL_BEAMSPRING)
#            define CAPSENSE_CONDUCTIVE_PLASTIC_IS_PULLED_UP_ON_KEYPRESS
#        else
#            define CAPSENSE_CONDUCTIVE_PLASTIC_IS_PUSHED_DOWN_ON_KEYPRESS
#            ifndef CAPSENSE_PHYSICAL_COL_TO_GPIO_COL
#                define CAPSENSE_PHYSICAL_COL_TO_GPIO_COL(col) (15 - (col))
#            endif
#        endif
#    endif
...
#    define CAPSENSE_HARDCODED_SAMPLE_TIME DEFAULT_HARDCODED_SAMPLE_TIME
#endif
...
#    if defined(CONTROLLER_IS_UNIVERSAL_BEAMSPRING) || defined(CONTROLLER_IS_UNIVERSAL_MODEL_F)
#        ifdef CAPSENSE_CONDUCTIVE_PLASTIC_IS_PULLED_UP_ON_KEYPRESS
...
#if (!defined(CAPSENSE_HARDCODED_THRESHOLD)) && !CAPSENSE_CAL_ENABLED
#    define CAPSENSE_HARDCODED_THRESHOLD 142
#endif

#ifndef CAPSENSE_PHYSICAL_COL_TO_GPIO_COL
#    define CAPSENSE_PHYSICAL_COL_TO_GPIO_COL(col) (col)
#endif
...
#define CAPSENSE_KEYMAP_COL_TO_GPIO_COL(col) CAPSENSE_PHYSICAL_COL_TO_GPIO_COL(CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col))

#if !defined(CAPSENSE_KEYMAP_ROW_TO_PHYSICAL_ROW) && !defined(CAPSENSE_PHYSICAL_ROW_TO_KEYMAP_ROW)
#    define CAPSENSE_KEYMAP_ROW_TO_PHYSICAL_ROW(row) (row)
#    define CAPSENSE_PHYSICAL_ROW_TO_KEYMAP_ROW(row) (row)
#endif

#define CAPSENSE_KEYMAP_ROW_TO_GPIO_ROW(row) CAPSENSE_PHYSICAL_ROW_TO_GPIO_ROW(CAPSENSE_KEYMAP_ROW_TO_PHYSICAL_ROW(row))
#define CAPSENSE_GPIO_ROW_TO_KEYMAP_ROW(row) CAPSENSE_PHYSICAL_ROW_TO_KEYMAP_ROW(CAPSENSE_GPIO_ROW_TO_PHYSICAL_ROW(row))
